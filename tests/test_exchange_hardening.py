...
def account_responses():
    ...
    return {
        ...
        "/fapi/v3/accountWithJoinMargin": {"canTrade": True,
            ...
            "positions": [{**{key: p[key] for key in ("symbol", "positionSide", "positionAmt", "entryPrice", "leverage")},
                           "unrealizedProfit": p["unRealizedProfit"], "maxNotional": "1000000",
                           "positionInitialMargin": "25", "isolated": False} for p in positions]},
