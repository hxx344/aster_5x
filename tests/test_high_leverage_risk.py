...
class HighLeverageRiskTests(unittest.TestCase):
    ...
    def test_state_returns_independent_account_limits_and_keeps_saved_base(self):
        ...
        self.assertEqual(state["test"]["risk_limits"], {"base": ".9", "high_leverage": "0.95", "migration": "0.95", "cycle": "0.95"})
        self.assertEqual(state["other"]["risk_limits"], {"base": ".98", "high_leverage": "1", "migration": "1", "cycle": "1"})
